...
build: build-img
	...
	&& RUSTFLAGS='-C linker=/usr/bin/x86_64-linux-gnu-gcc -C ar=/usr/bin/x86_64-linux-gnu-gcc-ar' cargo build -p http_server --release --target x86_64-unknown-linux-gnu" 
	rm -rf .temp
	mkdir .temp
